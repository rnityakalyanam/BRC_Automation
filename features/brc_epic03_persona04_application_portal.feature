Feature: brc_epic03_persona04_application_portal
...
Scenario:    BRC Applicantion Program Portal Application Creation
             ...
             And I wait for 2 sec                                                      
             Then I enter "eotss" into input field having id "applicant_first_name"
             And I enter "itd" into input field having id "applicant_last_name"
