Feature: brc_epic03_application_portal
...
Scenario:    BRC Applicantion Program Portal Application Creation
             ...
             And I wait for 2 sec               
             When I click on element having xpath "//*[@id='new_applicant']/div[1]/div/label[1]/span"             
             ...
             Then I select radio button having xpath "//*[@id='mailing-residential-form-next-btn']"
             And I wait for 3 sec
